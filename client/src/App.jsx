    ...
    >
      <div className="mx-auto space-y-8 max-w-7xl">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          {/* Theme Toggle Button - Fixed colors */}
          <button
            onClick={toggleTheme}
        ...
        <div className="flex justify-center">
          <button
            onClick={checkSpeed}
            disabled={loading}
            className="flex items-center gap-3 px-6 py-3 text-base font-semibold text-white transition-all duration-300 transform bg-blue-600 rounded-lg sm:px-8 sm:py-4 sm:text-lg hover:bg-blue-700 font-dm-sans hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
        ...
        {speedData && (
          <>
            <div className="grid grid-cols-1 gap-4 sm:gap-6 font-dm-sans md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  icon: Download,
            ...
            {/* Leaderboard */}
            <div className="px-2 mt-8 sm:px-4 sm:mt-12 font-poppins">
              <h2 className="mb-4 text-xl font-bold text-center sm:mb-6 sm:text-2xl font-dm-sans">
